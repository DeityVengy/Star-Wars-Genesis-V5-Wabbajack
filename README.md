...
# ATTENTION
# IF YOU ARE READING THIS, THEN STARFIELD HAD AN UPDATE. THIS MODLIST IS TEMPORARILY DOWN. PLEASE CHECK BACK IN A DAY OR SO FOR AN UPDATED VERSION (OR REFER TO MY DISCORD)
# ATTENTION
...
![Star Wars Genesis Requirements (8)](https://github.com/user-attachments/assets/1a20bb29-de7a-40bb-a766-08f97ac613fc)
...
I have obtained express permission from LucasFilm directly for many of the music tracks included in my Star Wars Music and Ambience Overhaul mod, which is included in this modlist. If you have any questions regarding the validity of this claim, please feel free to contact me directly, and I will provide the necessary documentation and contact information for further verification. Please note that this modlist also includes additional Star Wars music mods sourced from NexusMods. I am not responsible for any legal matters concerning those particular music tracks. For inquiries related to those mods, please contact NexusMods directly. If a music mod that the modlist depends on is take down due to copyright, I will simply take the tracks that I do have permissions to use from that mod and include it in my own mod.

The textures, plugins, and sounds included in **some** of the mods hosted on this GitHub repository are developed using a clean room design methodology. This means that these assets were independently created without direct reference to proprietary or copyrighted material from other existing mods. Consequently, no other mod or content creator has grounds or claims to request the removal of these mods based on intellectual property infringement. If there are any disputes regarding the originality of the assets, we invite the claimants to present a valid patent or evidence supporting their claims. This ensures that our work remains within legal boundaries while respecting the intellectual property rights of others. In other words, you do not own the idea of modifying an ingame asset any more than I do, unless you are specifically replacing the asset with that of your own creation. This includes altering the color of a vanilla outfit and the editing of vanilla plugin records. 
